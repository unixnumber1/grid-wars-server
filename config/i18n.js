...
const TRANSLATIONS = {
  ru: {
    ...
    'err.inventory_full': 'Инвентарь полон ({n} слотов) — продайте или скрафтите предметы',
    'err.max_slots_reached': 'Максимум слотов достигнут',
  ...
  en: {
    ...
    'err.inventory_full': 'Inventory full ({n} slots) — sell or craft items',
    'err.max_slots_reached': 'Max slots reached',
