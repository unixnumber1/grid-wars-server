...
export const FARMER_TREE = [
  ...
  // ТЕЛЕПОРТАЦИЯ
  {
    id: 'teleport_1', name: 'Охват I', emoji: '📡', maxLevel: 5, cost: 1,
    type: 'stat', tree: 'farmer',
  ...
  {
    id: 'teleport_2', name: 'Охват II', emoji: '📡', maxLevel: 5, cost: 1,
    type: 'stat', tree: 'farmer',
    effect: { collector_radius_bonus: 0.01 },
  ...
  {
    id: 'teleport_3', name: 'Охват III', emoji: '📡', maxLevel: 5, cost: 1,
    type: 'stat', tree: 'farmer',
    effect: { collector_radius_bonus: 0.01 },
  ...
  {
    id: 'teleport_4', name: 'Охват IV', emoji: '📡', maxLevel: 5, cost: 1,
    type: 'stat', tree: 'farmer',
    effect: { collector_radius_bonus: 0.01 },
  ...
  {
    id: 'teleport_5', name: 'Охват V', emoji: '📡', maxLevel: 5, cost: 1,
    type: 'stat', tree: 'farmer',
