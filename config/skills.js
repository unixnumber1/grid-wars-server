...
export const RAIDER_TREE = [
  ...
  { id: 'speed_1', name: 'Скорость I', emoji: '💨', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { attack_speed_bonus: 0.01 }, requires: 'crit_2', unlocks: ['speed_2'], position: { col: 8, row: 4 } },
  { id: 'speed_2', name: 'Скорость II', emoji: '💨', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { attack_speed_bonus: 0.01 }, requires: 'speed_1', unlocks: ['speed_3', 'vitality_1'], position: { col: 4, row: 5 } },
  { id: 'vitality_1', name: 'Живучесть I', emoji: '❤️', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { player_hp_bonus: 0.008 }, requires: 'speed_2', unlocks: ['vitality_2'], position: { col: 7, row: 6 } },
  ...
  { id: 'vitality_3', name: 'Живучесть III', emoji: '❤️', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { player_hp_bonus: 0.008 }, requires: 'vitality_2', unlocks: ['vitality_4', 'vampire_1'], position: { col: 6, row: 8 } },
  { id: 'vampire_1', name: 'Вампир I', emoji: '🩸', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { lifesteal: 0.003 }, requires: 'vitality_3', unlocks: ['vampire_2'], position: { col: 8, row: 9 } },
  { id: 'vampire_2', name: 'Вампир II', emoji: '🩸', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { lifesteal: 0.003 }, requires: 'vampire_1', unlocks: ['vampire_3'], position: { col: 4, row: 10 } },
  ...
  { id: 'destroyer_2', name: 'Разрушитель II', emoji: '🏛️', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { pve_damage_bonus: 0.008 }, requires: 'destroyer_1', unlocks: ['destroyer_3', 'marauder_1'], position: { col: 6, row: 13 } },
  { id: 'marauder_1', name: 'Мародёр I', emoji: '💀', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { pvp_loot_bonus: 0.01 }, requires: 'destroyer_2', unlocks: ['marauder_2'], position: { col: 8, row: 14 } },
  { id: 'marauder_2', name: 'Мародёр II', emoji: '💀', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { pvp_loot_bonus: 0.01 }, requires: 'marauder_1', unlocks: ['marauder_3'], position: { col: 4, row: 15 } },
  { id: 'marauder_3', name: 'Мародёр III', emoji: '💀', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { pvp_loot_bonus: 0.01 }, requires: 'marauder_2', unlocks: ['marauder_4', 'hunter_1'], position: { col: 7, row: 16 } },
  ...
  { id: 'hunter_2', name: 'Охотник II', emoji: '🏹', maxLevel: 5, cost: 1, type: 'stat', tree: 'raider', effect: { attack_radius_bonus: 2 }, requires: 'hunter_1', unlocks: ['hunter_3', 'shadow'], position: { col: 6, row: 18 } },
  { id: 'shadow', name: 'Тень', emoji: '🎭', maxLevel: 5, cost: 1, type: 'ability', tree: 'raider', effect: { shadow_ability: true }, description: 'Невидим на карте 30 мин, перезарядка 24ч', requires: 'hunter_2', unlocks: [], position: { col: 8, row: 19 }, dead_end: true },
...
export const FARMER_TREE = [
  // ═══ MAIN: income(2)→capacity(2)→durability(2)→regen(2)→defender(3)→territory(3)→gatherer(2)→teleport(3)→landlord = 20×5=100 ═══
  ...
  { id: 'income_2', name: 'Доход II', emoji: '💰', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_income_bonus: 0.01 }, requires: 'income_1', unlocks: ['income_3', 'capacity_1'], position: { col: 8, row: 1 } },
  ...
  { id: 'capacity_2', name: 'Вместимость II', emoji: '📦', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_capacity_bonus: 0.01 }, requires: 'capacity_1', unlocks: ['capacity_3', 'durability_1'], position: { col: 7, row: 3 } },
  { id: 'durability_1', name: 'Прочность I', emoji: '❤️', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_hp_bonus: 0.01 }, requires: 'capacity_2', unlocks: ['durability_2'], position: { col: 3, row: 4 } },
  { id: 'durability_2', name: 'Прочность II', emoji: '❤️', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_hp_bonus: 0.01 }, requires: 'durability_1', unlocks: ['durability_3', 'regen_1'], position: { col: 6, row: 5 } },
  { id: 'regen_1', name: 'Реген I', emoji: '♻️', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_regen_bonus: 0.01 }, requires: 'durability_2', unlocks: ['regen_2'], position: { col: 8, row: 6 } },
  { id: 'regen_2', name: 'Реген II', emoji: '♻️', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_regen_bonus: 0.01 }, requires: 'regen_1', unlocks: ['regen_3', 'defender_1'], position: { col: 4, row: 7 } },
  ...
  { id: 'defender_2', name: 'Защитник II', emoji: '🛡️', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_damage_reduction: 0.0067 }, requires: 'defender_1', unlocks: ['defender_3'], position: { col: 3, row: 9 } },
  { id: 'defender_3', name: 'Защитник III', emoji: '🛡️', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { mine_damage_reduction: 0.0067 }, requires: 'defender_2', unlocks: ['defender_4', 'territory_1'], position: { col: 6, row: 10 } },
  { id: 'territory_1', name: 'Территория I', emoji: '🌍', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { radius_bonus: 1 }, requires: 'defender_3', unlocks: ['territory_2'], position: { col: 8, row: 11 } },
  { id: 'territory_2', name: 'Территория II', emoji: '🌍', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { radius_bonus: 1 }, requires: 'territory_1', unlocks: ['territory_3'], position: { col: 4, row: 12 } },
  { id: 'territory_3', name: 'Территория III', emoji: '🌍', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { radius_bonus: 1 }, requires: 'territory_2', unlocks: ['territory_4', 'gatherer_1'], position: { col: 7, row: 13 } },
  { id: 'gatherer_1', name: 'Добытчик I', emoji: '✨', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { ore_bonus: 0.01 }, requires: 'territory_3', unlocks: ['gatherer_2'], position: { col: 3, row: 14 } },
  { id: 'gatherer_2', name: 'Добытчик II', emoji: '✨', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { ore_bonus: 0.01 }, requires: 'gatherer_1', unlocks: ['gatherer_3', 'teleport_1'], position: { col: 6, row: 15 } },
  { id: 'teleport_1', name: 'Охват I', emoji: '📡', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { collector_radius_bonus: 0.01 }, requires: 'gatherer_2', unlocks: ['teleport_2'], position: { col: 8, row: 16 } },
  { id: 'teleport_2', name: 'Охват II', emoji: '📡', maxLevel: 5, cost: 1, type: 'stat', tree: 'farmer', effect: { collector_radius_bonus: 0.01 }, requires: 'teleport_1', unlocks: ['teleport_3'], position: { col: 4, row: 17 } },
  ...
  { id: 'landlord', name: 'Землевладелец', emoji: '👑', maxLevel: 5, cost: 1, type: 'ability', tree: 'farmer', effect: { landlord_bonus: true }, description: 'Шахты в 200м от тебя дают +15% дохода пока онлайн', requires: 'teleport_3', unlocks: [], position: { col: 3, row: 19 }, dead_end: true },
