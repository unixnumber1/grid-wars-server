...
skillsRouter.post('/', async (req, res) => {
  try {
    ...
    switch (action) {
      case 'get':
        result = await handleGet(req.body, player);
        break;
      case 'invest':
        result = await handleInvest(req.body, player);
        break;
      case 'reset':
        result = await handleReset(req.body, player);
        break;
      case 'activate-shadow':
        result = await handleActivateShadow(req.body, player);
        break;
      default:
