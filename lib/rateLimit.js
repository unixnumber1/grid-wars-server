...
const LIMITS = {
  ...
  attack:   { max: 80,  window: 60000 },
  tick:     { max: 15,  window: 60000 },
  build:    { max: 20,  window: 60000 },
  collect:  { max: 30,  window: 60000 },
  market:   { max: 30,  window: 60000 },
  location: { max: 120, window: 60000 },
};
