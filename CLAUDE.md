...
- **Деплой**: `bash scripts/deploy.sh` на VPS или `git pull && pm2 restart all`
- **Автодеплой фронта**: scripts/front-watcher.js — polling GitHub API каждые 30с
...
/scripts
  ...
  front-watcher.js           — автодеплой фронта с GitHub
