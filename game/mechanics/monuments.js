...
export const MONUMENT_LEVELS = {
  1:  { hp: 30000,    max_shield_hp: 5000,    shield_regen: 30,   defenders_per_wave: [1,2],  defender_hp: 300,    defender_attack: 20,  gems: [30,60]    },
  2:  { hp: 70000,    max_shield_hp: 10000,   shield_regen: 60,   defenders_per_wave: [1,3],  defender_hp: 500,    defender_attack: 35,  gems: [60,100]   },
  3:  { hp: 150000,   max_shield_hp: 20000,   shield_regen: 120,  defenders_per_wave: [2,4],  defender_hp: 900,    defender_attack: 55,  gems: [100,200]  },
  4:  { hp: 300000,   max_shield_hp: 40000,   shield_regen: 240,  defenders_per_wave: [2,5],  defender_hp: 1800,   defender_attack: 80,  gems: [200,350]  },
  5:  { hp: 600000,   max_shield_hp: 80000,   shield_regen: 480,  defenders_per_wave: [3,7],  defender_hp: 3500,   defender_attack: 120, gems: [350,600]  },
  6:  { hp: 1200000,  max_shield_hp: 150000,  shield_regen: 700,  defenders_per_wave: [3,8],  defender_hp: 7000,   defender_attack: 170, gems: [600,1000] },
  7:  { hp: 2500000,  max_shield_hp: 300000,  shield_regen: 1000, defenders_per_wave: [4,10], defender_hp: 14000,  defender_attack: 240, gems: [1000,1500]},
  8:  { hp: 5000000,  max_shield_hp: 600000,  shield_regen: 1200, defenders_per_wave: [5,13], defender_hp: 28000,  defender_attack: 340, gems: [1500,2500]},
  9:  { hp: 10000000, max_shield_hp: 1200000, shield_regen: 1350, defenders_per_wave: [6,16], defender_hp: 55000,  defender_attack: 480, gems: [2500,3500]},
  10: { hp: 20000000, max_shield_hp: 2500000, shield_regen: 1500, defenders_per_wave: [8,20], defender_hp: 110000, defender_attack: 680, gems: [3500,5000]},
};
...
export async function spawnMonuments() {
  ...
  for (const cluster of clusters) {
    ...
    // Query Overpass for urban landmarks
    const query = `
      [out:json][timeout:15];
      (
        nwr["historic"="monument"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        nwr["tourism"="attraction"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        nwr["amenity"="place_of_worship"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        nwr["historic"="memorial"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        ...
        nwr["amenity"="library"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        nwr["amenity"="townhall"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        nwr["tourism"="artwork"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
        node["place"="square"](around:${MAX_DISTANCE},${cluster.lat},${cluster.lng});
      );
      out center 100;
    `;
      ...
      if (resp.ok) {
        ...
        osmPoints = (data.elements || [])
          ...
          .map(el => {
            ...
            const tags = el.tags || {};
            return { lat, lng, name: tags.name || null };
          });
      }
    } catch (e) {
