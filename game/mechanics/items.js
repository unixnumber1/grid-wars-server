...
const SHIELD_STATS = {
  ...
  mythic_1:    { defense: [4200, 6200],  block_chance: [14, 22] },
  mythic_2:    { defense: [5000, 7200],  block_chance: [16, 24] },
  mythic_3:    { defense: [5900, 8400],  block_chance: [18, 26] },
  legendary:   { defense: [5400, 8100],  block_chance: [22, 30] },
  legendary_1: { defense: [6400, 9500],  block_chance: [24, 32] },
  legendary_2: { defense: [7500, 11000], block_chance: [26, 34] },
  legendary_3: { defense: [8800, 12800], block_chance: [28, 36] },
};
