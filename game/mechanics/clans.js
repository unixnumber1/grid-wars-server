...
export const CLAN_LEVELS = [
  { level: 1,  radius: 75,  income: 5,  defense: 10, maxMembers: 5,   cost: 0,      boostCost: 100,  boostMul: 2.0 },
  { level: 2,  radius: 100, income: 8,  defense: 15, maxMembers: 10,  cost: 2000,   boostCost: 300,  boostMul: 2.2 },
  { level: 3,  radius: 125, income: 11, defense: 20, maxMembers: 15,  cost: 4000,   boostCost: 500,  boostMul: 2.5 },
  { level: 4,  radius: 150, income: 14, defense: 26, maxMembers: 20,  cost: 7000,   boostCost: 700,  boostMul: 2.8 },
  { level: 5,  radius: 175, income: 17, defense: 32, maxMembers: 25,  cost: 12000,  boostCost: 950,  boostMul: 3.2 },
  { level: 6,  radius: 200, income: 20, defense: 38, maxMembers: 30,  cost: 20000,  boostCost: 1150, boostMul: 3.6 },
  { level: 7,  radius: 225, income: 23, defense: 45, maxMembers: 35,  cost: 32000,  boostCost: 1400, boostMul: 4.0 },
  { level: 8,  radius: 250, income: 26, defense: 52, maxMembers: 40,  cost: 48000,  boostCost: 1600, boostMul: 4.5 },
  { level: 9,  radius: 275, income: 28, defense: 62, maxMembers: 45,  cost: 72000,  boostCost: 1800, boostMul: 5.0 },
